...
const MAPBOX_TOKEN = 'pk.eyJ1IjoibG92YWJsZWRldiIsImEiOiJjbGpxZncwenYwMnFlM3FsMWhzMWMxZGMyIn0.jYmQN2WiQR1clqF9N3ORRA';
...
const ServiceAreaMap = () => {
  ...
  useEffect(() => {
    ...
    map.current.on('load', () => {
      ...
      const oakvillePolygon = turf.polygon([OAKVILLE_COORDINATES]);
